...
c.fn.extend({
    ...
    scrollParent:function(){
        ...
        ?this.parents().filter(function(){
            ...
            /(auto|scroll)/.test(c.curCSS(this,"overflow",1)+c.curCSS(this,"overflow-y",1)+c.curCSS(this,"overflow-x",1))}).eq(0):this.parents().filter(function(){
    ...
    c.each(["Width","Height"],function(a,b){
        function d(f,g,m,n){
            c.each(e,function(){
                ...
                return g}var e=b==="Width"?["Left","Right"]:["Top","Bottom"],
                h=b.toLowerCase(),
                i={innerWidth:c.fn.innerWidth,
