                    ...
                    for (var l = 0, m = d.length; l < m; l++) {
                        ...
                        q == "t" && o == 3
                            ...
                            ? o == 2 || o == 3
                                ...
                                : o == 5 && (s ? ((w = t.x(n[3], n[4])), (x = t.y(n[3], n[4])), k.scale(n[1], n[2], w, x)) : k.scale(n[1], n[2], n[3], n[4]), (h *= n[1]), (i *= n[2]))
            ...
            var q = function (d, e) {
                ...
                t = function (d, e, f) {
                    if (d.type == "path") {
                        ...
                        r == "open" ? ((x += 2), (y += 2), (z += 2), (u = 1), (v = f ? 4 : 1), (w = { fill: "none", stroke: k.stroke })) : ((v = u = x / 2), (w = { fill: k.stroke, stroke: "none" })),
                            d._.arrows
                                ? f
                        ...
                        if (r != "none") {
                            ...
                            C
                                ...
                                : ((C = q(q("marker"), { id: B, markerHeight: y, markerWidth: x, orient: "auto", refX: v, refY: y / 2 })),
                                  (D = q(q("use"), { "xlink:href": "#" + A, transform: (f ? "rotate(180 " + x / 2 + " " + y / 2 + ") " : l) + "scale(" + x / z + "," + y / z + ")", "stroke-width": (1 / ((x / z + y / z) / 2)).toFixed(4) })),
                                  C.appendChild(D),
                    ...
                    if ("clip-rect" in i) {
                        ...
                        if (H.length == 4) {
                            ...
                            (J.clip = a.format("rect({1}px {2}px {3}px {0}px)", H)),
                                l.clipRect || ((J.position = "absolute"), (J.top = 0), (J.left = 0), (J.width = e.paper.width + "px"), (J.height = e.paper.height + "px"), l.parentNode.insertBefore(I, l), I.appendChild(l), (l.clipRect = I));
                        }
                        ...
                        if (L.on && i.fill) {
                            ...
                            if (N) {
                                ...
                                (L.color = a.getRGB(i.fill).hex),
                                    (L.src = o),
                                    (L.type = "solid"),
                                    a.getRGB(i.fill).error && (t.type in { circle: 1, ellipse: 1 } || c(i.fill).charAt() != "r") && C(t, i.fill, L) && ((m.fill = "none"), (m.gradient = i.fill), (L.rotate = !1));
                        }
