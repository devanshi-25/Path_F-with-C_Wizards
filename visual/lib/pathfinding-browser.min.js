                    ...
                    (r.prototype._buildNodes = function (t, e, r) {
                        ...
                        (r.prototype.getNeighbors = function (t, e, r) {
                            ...
                            return (
                                ...
                                e
                                    ? (r ? ((a = c && s), (h = s && u), (p = u && l), (f = l && c)) : ((a = c || s), (h = s || u), (p = u || l), (f = l || c)),
                                      a && this.isWalkableAt(i - 1, n - 1) && o.push(d[n - 1][i - 1]),
                        ...
                        (r.prototype.clone = function () {
                            var t,
                                ...
                                a = new r(n, o),
                                u = new Array(o);
                            for (t = 0; o > t; ++t) for (u[t] = new Array(n), e = 0; n > e; ++e) u[t][e] = new i(e, t, s[t][e].walkable);
                            return (a.nodes = u), a;
                        }),
                        (e.exports = r);
                },
                            ...
                            for (u = s.getNeighbors(a, k, m), l = 0, p = u.length; p > l; ++l)
                                (h = u[l]),
                                    h.closed ||
                                        ...
                                        (!h.opened || d < h.g) && ((h.g = d), (h.h = h.h || v * A(w(c - r), w(f - o))), (h.f = h.g + h.h), (h.parent = a), h.opened ? g.updateItem(h) : (g.push(h), (h.opened = !0))));
                        }
                        return [];
                    }),
                        (e.exports = r);
                            ...
                            for (a = b.pop(), a.closed = !0, u = s.getNeighbors(a, v, w), l = 0, p = u.length; p > l; ++l)
                                if (((h = u[l]), !h.closed)) {
                                    ...
                                    (c = h.x),
                                        ...
                                        (!h.opened || d < h.g) && ((h.g = d), (h.h = h.h || x * m(F(c - r), F(f - o))), (h.f = h.g + h.h), (h.parent = a), h.opened ? b.updateItem(h) : (b.push(h), (h.opened = N)));
                                }
                            for (a = y.pop(), a.closed = !0, u = s.getNeighbors(a, v, w), l = 0, p = u.length; p > l; ++l)
                                if (((h = u[l]), !h.closed)) {
                                    ...
                                    (c = h.x),
                                        (f = h.y),
                                        (d = a.g + (0 === c - a.x || 0 === f - a.y ? 1 : W)),
                                        (!h.opened || d < h.g) && ((h.g = d), (h.h = h.h || x * m(F(c - t), F(f - e))), (h.f = h.g + h.h), (h.parent = a), h.opened ? y.updateItem(h) : (y.push(h), (h.opened = C)));
                                }
                        }
                        return [];
                    }),
                        ...
                        (r.prototype._identifySuccessors = function (t) {
                            ...
                            for (Math.max, e = this._findNeighbors(t), n = 0, s = e.length; s > n; ++n)
                                if (((r = e[n]), (i = this._jump(r[0], r[1], y, A)))) {
                                    ...
                                    (h = o.octile(k(a - y), k(u - A))),
                                        (l = t.g + h),
                                        (!p.opened || l < p.g) && ((p.g = l), (p.h = p.h || f(k(a - g), k(u - b))), (p.f = p.g + p.h), (p.parent = t), p.opened ? d.updateItem(p) : (d.push(p), (p.opened = !0)));
                                }
                        }),
                                ...
                                (e = h.x),
                                    ...
                                    0 !== i && 0 !== n
                                        ? (c.isWalkableAt(l, p + n) && f.push([l, p + n]),
                                          ...
                                          (c.isWalkableAt(l, p + n) || c.isWalkableAt(l + i, p)) && f.push([l + i, p + n]),
                                          !c.isWalkableAt(l - i, p) && c.isWalkableAt(l, p + n) && f.push([l - i, p + n]),
                                          !c.isWalkableAt(l, p - n) && c.isWalkableAt(l + i, p) && f.push([l + i, p - n]))
                                        : 0 === i
                                        ? c.isWalkableAt(l, p + n) && (f.push([l, p + n]), c.isWalkableAt(l + 1, p) || f.push([l + 1, p + n]), c.isWalkableAt(l - 1, p) || f.push([l - 1, p + n]))
                        ...
                        (r.prototype._findNeighbors = function (t) {
                            ...
                            if (h)
                                (e = h.x),
                                    ...
                                    (n = (p - r) / Math.max(Math.abs(p - r), 1)),
                                    0 !== i
                                        ? (c.isWalkableAt(l, p - 1) && f.push([l, p - 1]), c.isWalkableAt(l, p + 1) && f.push([l, p + 1]), c.isWalkableAt(l + i, p) && f.push([l + i, p]))
                                        : 0 !== n && (c.isWalkableAt(l - 1, p) && f.push([l - 1, p]), c.isWalkableAt(l + 1, p) && f.push([l + 1, p]), c.isWalkableAt(l, p + n) && f.push([l, p + n]));
            ...
            21: [
                function (t, e) {
                    e.exports = {
                        ...
                        DepthFirstFinder: t("./finders/DepthFirstFinder"),
                        ...
                        BiDepthFirstFinder: t("./finders/BiDepthFirstFinder"),
                ...
                },
                {
                    ...
                    "./finders/DepthFirstFinder": 14,
                    "./finders/DijkstraFinder": 15,
                    "./finders/IDAStarFinder": 16,
                    "./finders/JumpPointFinder": 17,
                    "./finders/BiDepthFirstFinder": 18,
                    "./finders/OrthogonalJumpPointFinder": 19,
                    "./finders/TraceFinder": 20,
                    heap: 1,
                },
            ],
        },
