(function (n) {
    "function" == typeof define ? define(n) : n();
})(function () {
    function n(a) {
        try {
    ...
    if (!Array.prototype.map)
        Array.prototype.map = function (a, d) {
            var b = i(this),
                c = b.length >>> 0,
                e = Array(c);
            if ("[object Function]" != m(a)) throw new TypeError();
    ...
    if (!Array.prototype.filter)
        Array.prototype.filter = function (a, d) {
            var b = i(this),
                c = b.length >>> 0,
                e = [];
            if ("[object Function]" != m(a)) throw new TypeError();
    ...
    if (!Array.prototype.every)
        Array.prototype.every = function (a, d) {
            var b = i(this),
                c = b.length >>> 0;
            if ("[object Function]" != m(a)) throw new TypeError();
            for (var e = 0; e < c; e++) if (e in b && !a.call(d, b[e], e, b)) return !1;
            return !0;
        };
    if (!Array.prototype.some)
        Array.prototype.some = function (a, d) {
            var b = i(this),
                c = b.length >>> 0;
            if ("[object Function]" != m(a)) throw new TypeError();
    ...
    if (!Array.prototype.reduceRight)
        Array.prototype.reduceRight = function (a) {
            ...
            do b in this && (c = a.call(void 0, c, d[b], b, d));
            while (b--);
            return c;
        };
    if (!Array.prototype.indexOf)
        Array.prototype.indexOf = function (a) {
            ...
            for (c = 0 <= c ? c : Math.max(0, b + c); c < b; c++) if (c in d && d[c] === a) return c;
            return -1;
        };
    if (!Array.prototype.lastIndexOf)
        Array.prototype.lastIndexOf = function (a) {
            ...
            if (!b) return -1;
            var c = b - 1;
            1 < arguments.length && (c = Math.min(c, v(arguments[1])));
    ...
    if (!Object.defineProperties)
        Object.defineProperties = function (a, d) {
            for (var b in d) h(d, b) && Object.defineProperty(a, b, d[b]);
            return a;
        };
    if (!Object.seal)
    ...
    if (!Date.prototype.toISOString || -1 === new Date(-621987552e5).toISOString().indexOf("-000001"))
    ...
    if (!Date.parse || 864e13 !== Date.parse("+275760-09-13T00:00:00.000Z"))
        Date = (function (a) {
            var d = function g(b, d, c, f, h, i, j) {
